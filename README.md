This project will be using javascript to create a puzzle game named "FIZZ-BUZZ" in which the user inputs a number and the output shows the numbers starting from 1 to the input number by user .
